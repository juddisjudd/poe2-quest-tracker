...
const electronAPI = {
  ...
  startTreeWindowResize: (direction: string) => ipcRenderer.invoke("start-tree-window-resize", direction),
  resizeTreeWindow: (mouseX: number, mouseY: number) => ipcRenderer.invoke("resize-tree-window", mouseX, mouseY),
  endTreeWindowResize: () => ipcRenderer.invoke("end-tree-window-resize"),
